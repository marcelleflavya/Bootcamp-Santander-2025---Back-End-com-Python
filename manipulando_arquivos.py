...
#Dessa forma vai ter persistência de dados e vai possibilitar uma revisão e análise detalhada das operações.
#O decorador deve ter
#data e hora atuais,
#  nome da função, 
# argumentos da função, 
# valor retornado da função,
# o arquivo de log deve ser chamado log.txt, 
# se o log. txt já exixtir, os novos logs devem ser adicionados ao final de cada arquivo, 
